  ...
  return (
    <div className="border-b border-slate-100 dark:border-slate-800 px-5 sticky top-0 backdrop-blur-md bg-white/80 dark:bg-slate-950/80 z-50 transition-colors duration-300">
      <nav className="flex justify-between items-center py-3 max-w-7xl mx-auto w-full">
        ...
        {/* Desktop Menu - Links updated based on requirement docs */}
                ...
                {isDropdownOpen && (
                  ...
                  >
                    ...
                    <button 
                      ...
                      className="w-full text-left px-4 py-2 text-sm text-rose-600 hover:bg-rose-50 dark:hover:bg-rose-950/30 transition font-medium"
                    >
                      Logout
                    </button>
                  </motion.div>
            ...
            <div className="flex flex-col gap-3 p-5">
              ...
              {session && (
                <>
                  ...
                  <Link href="/dashboard" onClick={() => setIsOpen(false)} className="text-slate-700 dark:text-slate-300 font-semibold py-2 hover:text-rose-600">Dashboard</Link>
                </>
              )}
