      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <Card className="lg:col-span-2 bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-gray-100 space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="space-y-6">
              <h3 className="font-bold text-lg flex items-center gap-2"><User className="text-[#ff0000]" size={20} /> Personal Information</h3>
            ...
            <div className="space-y-6">
              <h3 className="font-bold text-lg flex items-center gap-2"><Building2 className="text-[#ff0000]" size={20} /> Address Details</h3>
        ...
        <Card className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 flex flex-col gap-6 h-fit">
          <div className="flex items-center gap-2">
            <div className="p-2 bg-rose-50 rounded-lg"><Droplets className="text-[#ff0000]" size={20} /></div>
