  ...
  return (
    <div className="flex min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100">
      ...
      <aside className="w-64 border-r border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-5 flex flex-col justify-between">
          ...
          <nav className="space-y-6">
            <div>
              ...
              <ul className="space-y-1">
                ...
                <li>
                  <Link href="/volunteer/profile" className="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800">
            ...
            <div>
              <p className="text-xs font-bold uppercase tracking-wider text-slate-400 mb-2">Donations</p>
              <ul className="space-y-1">
                <li>
                  <Link href="/volunteer/dashboard" className="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800">
        ...
        {/* Volunteer Footer Info inside Sidebar */}
        <div className="border-t border-slate-200 dark:border-slate-800 pt-4">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-9 h-9 rounded-full bg-blue-600 flex items-center justify-center text-white font-bold">V</div>
            <div>
              <p className="text-xs font-bold">Volunteer Panel</p>
